...
def cargar_imagenes():
    ...
    segmentador.predict()
    path_pred = '../Avance #2 Proyecto ACS/SegmentacionCelulas/imgs_mask_predict.npy'
    gestor_imagenes.copiar_preds_static(path_pred)
    return render_template('cargadoDeImagenes.html',
                           nombresImagenes=imagenes_nombres)
